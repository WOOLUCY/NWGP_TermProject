...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	static CImage Start, Dialog[6], Guide, Block, Heart, Key, Portal, Clear[2], Guide2, GameOver, Monster_L[4], Monster_R[4], Map, Damage;
	...
	case WM_CREATE:
		...
		w_damage = Damage.GetWidth();
		h_damage = Damage.GetHeight();
	...
	case WM_PAINT:
		...
		if (DamageNum == 1) {
			Damage.Draw(mem1dc, x, y - 50, w_damage, h_damage, 0, 0, w_damage, h_damage);
		}
